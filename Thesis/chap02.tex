...
In this section, we will go into more detail and why we decided thing should be this way.

\subsection{Attacker Behavior}

- !!!use other TDs as examples!!!

- continuous vs automatic waves vs manual waves
