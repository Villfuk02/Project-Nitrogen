...
\textbf{Tower defense}~\cite{TDWiki} \xxx{source???} is a subgenre of \emph{real-time strategy}.
...
However, there will be no map screen to let them choose their path as described in paragraph \nameref{ov-par:run-progression} of the previous section.
...
\begin{enumerate}
    ...
    \item Implement all the systems and mechanics described in paragraphs \nameref{ov-par:battles}, \nameref{ov-par:procedural-generation} and \nameref{ov-par:blueprints}.
