...
\def\Abstract{%
    In this thesis, we designed and implemented a demo version of a rogue-like tower defense game.
...
\def\AbstractCS{%
    V této práci jsme navrhli a implementovali demo verzi rogue-like tower defense hry.
    ...
    Nakonec jsme provedli playtest k získání zpětné vazby.
    Ta nám umožnila ověřit návrhová rozhodnutí a identifikovat důležité oblasti pro zlepšení, například uživatelské rozhraní a systém správy surovin.
}
