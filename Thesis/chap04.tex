...
What happens next is explained in section \xxx{TODO}.
...
The interactions described in this subsection are shown in figure~\ref{fig:wave-controller-interactions}.
...
A tower's range can be composed of many \mono{TargetingCollider}s, and they can be combined with any boolean operations to create various range shapes.
...
\xxx{TODO diagram similar to waves}
