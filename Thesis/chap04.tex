...
In battle, there are also some game objects which persist between scenes and don't originally come from the \emph{Battle} scene.
...
After the player beats a level, the \mono{RunPersistence} asks the \mono{BlueprintReward-} \mono{Controller} to reward the player with blueprints.
