...
\head{Distribute new rate and capacity evenly.}{}
...
\head{Improve it by removing invalid options in advance.}{}
...
\head{Make sure every generated wave uses up the capacity.}{}
...
\head{Check if we can use up the path capacities.}{}
...
\head{Check if we can use up the global capacity.}{}
...
\head{Select attacker count and distribute new rate and capacity.}{}
...
An example modifiable query for determining attacker speed is shown in figure~\ref{fig:modifiable-query}.
